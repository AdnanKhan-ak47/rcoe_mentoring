...
const ProblemItem = (props) => {
    let { title, description, date_start, id } = props
    ...
    return (
        <div className='border border-gray-200 shadow-md m-5 rounded-lg p-2 flex flex-row justify-between'>
            <div className=''>
            ...
            <div onClick={() => {deleteProblem(id)}} className='flex place-self-end border border-slate-200 hover:bg-slate-400'>
                <svg className='' xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0 0 100 100">
